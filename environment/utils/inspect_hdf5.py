...
INPUT_H5 = Path(
    "/media/czhang883/PORTABLE_SSD/libero_random_exploration/data_dir/scratch/libero/env_rand_samples/lb_randsam_goal_100ep_20260301_042335.hdf5"
)
OUTPUT_MP4 = INPUT_H5.with_name(f"{INPUT_H5.stem}_all_rgb_concat.mp4")
FPS = 30
SPEEDUP = 32  # keep 1 to inspect every frame
